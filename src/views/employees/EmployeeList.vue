<template>
  ...
  <v-card class="px-4 py-4">
    <router-link v-if="canEdit" :to="createEmployee">
      <v-btn min-width="46" width="46" height="46" variant="flat" title="Создать пользователя" class="table-head-icon">
...
import {FILTER_TYPE_EQ_MULTI, FILTER_TYPE_EQ_MULTI_WITH_SEARCH, FILTER_TYPE_LIKE} from "@/utils/dictionary.js";
import {useStore} from "vuex";
import {employeeDepartmentForFilter, employeePostForFilter} from "@/service/employees/dictionaryService.js";
