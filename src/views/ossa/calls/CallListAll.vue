...
import {
  CALL_TYPES, DISPOSITION_TYPES, EXCHANGE_TYPES, FILTER_TYPE_BETWEEN,
  FILTER_TYPE_DATE_TIME, FILTER_TYPE_EQ, FILTER_TYPE_EQ_BY_GROUP, FILTER_TYPE_EQ_CHECK, FILTER_TYPE_EQ_MULTI,
  FILTER_TYPE_LIKE,
} from "@/utils/dictionary.js";
import { useStore } from "vuex";
import {callDownload, callList} from "@/service/ossa/calls/callService.js";
...
const handleDownloadFile = async (item) => {
  ...
  downloadFile(res, item.filename.split("/").pop())
}
